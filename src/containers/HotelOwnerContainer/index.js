    ...
    return (
      <div className="RMHotelContainer">
        <HOHeader h="0" doClick={this.onclick}/>
          ...
          <HotelReservations key="I3" selected={this.state.selectedPage} />
          <ProfileHotel      key="I4" selected={this.state.selectedPage} />
          <HotelPolicies     key="I5" selected={this.state.selectedPage} />
          <HotelFacilities   key="I6" selected={this.state.selectedPage} />
        </div>
      </div>
    )
  }
